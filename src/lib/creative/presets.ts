...
export const PRESETS: Record<string, CreativeSpec> = {
  ...
  "02-mujer-encontro-comprador": {
    ...
    overlay: { color: "purple-500", from: 0.55, to: 0.8, angle: 135 },
    protagonista: {
      recipe: {
        tipo: "persona",
        genero: "mujer",
  ...
  "03-casa-infografia": {
    ...
    protagonista: {
      recipe: {
        ...
        sujeto:
          "casa pequeña de un piso en render 3D isométrico, vista tres cuartos desde el frente, techo a dos aguas color morado vibrante con paneles solares, paredes de concreto claro con textura sutil, puerta principal de madera con manija negra, una ventana con marco negro, escalón de entrada, chimenea morada, iluminación de estudio suave con brillo cálido en los bordes",
        libre: "sobre fondo plano neutro para recorte, sin suelo ni sombra proyectada extensa, estilo render limpio tipo producto",
      },
      anchor: "bottom-center",
      widthPct: 46,
      offset: [0, -17],
    ...
    cta: {
      ...
      glyph: "chevron-down",
      box: { x: 17, y: 86.5, w: 66, h: 8 },
      pillColor: "white",
      textColor: "purple-800",
    },
    logo: { slot: "top-center", heightCu: 96, format: "completo", treatment: "colorSobreBlanco", marginCu: 48 },
    legal: "*AplicanTyC",
  },
